...
## [Unreleased]
Planned: verification refresh worker (Worker 2), notifications worker (Worker 4, Brevo), WHOIS domain-age check, OCR for scanned CVs, curator partner pilot (Halo), BYOK option for users, per-user quotas, Postgres migration when multi-instance is needed.
